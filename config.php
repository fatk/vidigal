...
/*
    Environment Check (This should be define in wp-config.php or wp-local.php)
*/

if (!defined('_ENVIRONMENT_')) {
    define('_ENVIRONMENT_', 'dev');
}
...
define('_PATH_ASSETS_ICONS_', _PATH_ASSETS_.'/icons');
...
define('_ABSPATH_ASSETS_ICONS_', dirname(__FILE__).'/'._PATH_ASSETS_ICONS_);
...
define('_URIPATH_ASSETS_ICONS_', get_template_directory_uri().'/'._PATH_ASSETS_ICONS_);
